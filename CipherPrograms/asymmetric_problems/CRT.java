...
public class CRT {
  ...
  public static void main(String[] args) {
     ...
     */
    BigInteger[] constraints = { BigInteger.valueOf(330), BigInteger.valueOf(34), BigInteger.valueOf(419) }; //put modular contraints here
    BigInteger[] mods = { BigInteger.valueOf(377), BigInteger.valueOf(391), BigInteger.valueOf(589)}; //put moduli here
