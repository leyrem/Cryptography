...
public class CRT {
  ...
  public static void main(String[] args) {
     ...
     */
    BigInteger[] constraints = { new BigInteger("1413001440101171355838004910913"), new BigInteger("853411942675766148254332532142"), new BigInteger("1495760151621084203783621722244")}; //put modular contraints here
    BigInteger[] mods = { new BigInteger("1840747134396411995203346457427"), new BigInteger("2603380569631208312046083975233"), new BigInteger("3501257041174466943566969049389") }; //put moduli here
